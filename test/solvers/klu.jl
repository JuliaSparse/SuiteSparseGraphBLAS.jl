...
using SuiteSparseGraphBLAS.GB_KLU: GB_KLUFactorization, pack!, unpack!
using SparseArrays
...
@testset "Issue #4" begin
    ...
    unpack!(A, SuiteSparseGraphBLAS.Sparse(); attachfinalizer = false)
end